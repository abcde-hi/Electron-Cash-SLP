PACKAGE_VERSION = '3.7.2'  # version of the client package, this is used by update_checker.py
PRE_RELEASE_TAG = '3.7.2' # title bar tag used for pre-releases, doesn't affect update_checker.py
